...
export const translations: Record<Language, TranslationTree> = {
  en: {
    ...
    chat: {
      ...
      fontMedium: 'Medium',
      fontLarge: 'Large',
      htmlImportTitle: 'HTML Template Import',
      htmlImportSubtitle: 'Create a new html-template graph from a live URL with css-node + html-node.',
      htmlImportShow: 'Show import',
      htmlImportHide: 'Hide import',
      htmlImportUrlPlaceholder: 'https://example.com/',
      htmlImportGraphTitlePlaceholder: 'Graph title (optional)',
      htmlImportDescriptionPlaceholder: 'Description (optional)',
      htmlImportModeNew: 'A) Create new graph',
      htmlImportModeCurrent: 'B) Import into current graph',
      htmlImportTargetGraphPlaceholder: 'Current graph ID (target)',
      htmlImportCta: 'Import URL',
      htmlImportImporting: 'Importing...',
      htmlImportOpenGraph: 'Open in GNewViewer',
      htmlImportSuccess: 'Imported graph:',
      htmlImportSuccessCurrent: 'Imported into graph:',
      htmlImportStats: 'Size',
      message: 'Message',
  ...
  is: {
    ...
    chat: {
      ...
      fontMedium: 'Miðlungs',
      fontLarge: 'Stórt',
      htmlImportTitle: 'HTML Template innflutningur',
      htmlImportSubtitle: 'Búðu til nýtt html-template graf úr URL með css-node + html-node.',
      htmlImportShow: 'Sýna innflutning',
      htmlImportHide: 'Fela innflutning',
      htmlImportUrlPlaceholder: 'https://example.com/',
      htmlImportGraphTitlePlaceholder: 'Titill grafs (valfrjálst)',
      htmlImportDescriptionPlaceholder: 'Lýsing (valfrjálst)',
      htmlImportModeNew: 'A) Búa til nýtt graf',
      htmlImportModeCurrent: 'B) Flytja inn í núverandi graf',
      htmlImportTargetGraphPlaceholder: 'Graf auðkenni (target)',
      htmlImportCta: 'Flytja inn URL',
      htmlImportImporting: 'Flyt inn...',
      htmlImportOpenGraph: 'Opna í GNewViewer',
      htmlImportSuccess: 'Innflutt graf:',
      htmlImportSuccessCurrent: 'Flutt inn í graf:',
      htmlImportStats: 'Stærð',
      message: 'Skilaboð',
  ...
  no: {
    ...
    chat: {
      ...
      fontMedium: 'Middels',
      fontLarge: 'Stor',
      htmlImportTitle: 'Import av HTML-template',
      htmlImportSubtitle: 'Opprett en ny html-template-graf fra en URL med css-node + html-node.',
      htmlImportShow: 'Vis import',
      htmlImportHide: 'Skjul import',
      htmlImportUrlPlaceholder: 'https://example.com/',
      htmlImportGraphTitlePlaceholder: 'Graf-tittel (valgfritt)',
      htmlImportDescriptionPlaceholder: 'Beskrivelse (valgfritt)',
      htmlImportModeNew: 'A) Opprett ny graf',
      htmlImportModeCurrent: 'B) Importer til nåværende graf',
      htmlImportTargetGraphPlaceholder: 'Nåværende graf-ID (mål)',
      htmlImportCta: 'Importer URL',
      htmlImportImporting: 'Importerer...',
      htmlImportOpenGraph: 'Åpne i GNewViewer',
      htmlImportSuccess: 'Importert graf:',
      htmlImportSuccessCurrent: 'Importert til graf:',
      htmlImportStats: 'Størrelse',
      message: 'Melding',
  ...
  nl: {
    ...
    chat: {
      ...
      fontLarge: 'Groot',
      htmlImportTitle: 'HTML Template import',
      htmlImportSubtitle: 'Maak een nieuwe html-template graph vanaf een URL met css-node + html-node.',
      htmlImportShow: 'Toon import',
      htmlImportHide: 'Verberg import',
      htmlImportUrlPlaceholder: 'https://example.com/',
      htmlImportGraphTitlePlaceholder: 'Graph-titel (optioneel)',
      htmlImportDescriptionPlaceholder: 'Beschrijving (optioneel)',
      htmlImportModeNew: 'A) Nieuwe graph maken',
      htmlImportModeCurrent: 'B) Importeren in huidige graph',
      htmlImportTargetGraphPlaceholder: 'Huidige graph-ID (doel)',
      htmlImportCta: 'Importeer URL',
      htmlImportImporting: 'Importeren...',
      htmlImportOpenGraph: 'Open in GNewViewer',
      htmlImportSuccess: 'Geïmporteerde graph:',
      htmlImportSuccessCurrent: 'Geïmporteerd in graph:',
      htmlImportStats: 'Grootte',
      message: 'Bericht',
